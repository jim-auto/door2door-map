...
257区間の実時刻表データ（[トラベルタウンズ](https://www.traveltowns.jp/)）で検証:
...
> 単一速度モデル (50 km/h 固定) では OK 69% / 平均誤差 4.1分 が上限だった。
> 距離帯別に実表定速度が大きく異なる（短距離の地下鉄 ≈35 km/h、長距離の快速 ≈57 km/h）ため、
> 乗車オーバーヘッド項を加えたアフィンモデルで精度を改善している。
